...
import * as strings from 'InfoIisWebPartStrings';
import { pivotOptionsGroup} from './index';

import * as links from '../../webparts/InfoIis/components/HelpInfo/AllLinks';   //              { links.gitRepoInfoIis.issues }

import { IInfoIisWebPartProps } from '../../webparts/infoIis/InfoIisWebPart';
...
/*
  ...
  // 4 -Project options
  allowUserProjects: boolean; //Will build list of ProjectsUser based on existing data from InfoIis list
...
export class IntroPage {
  public getPropertyPanePage(webPartProps: IInfoIisWebPartProps, _onClickCreateChild, _onClickCreateParent, _onClickUpdateTitles ): IPropertyPanePage {
    ...
    { // <page1>
      ...
      groups: [
        { groupName: 'Web Part Info',
          ...
          groupFields: [
            ...
            PropertyPaneLink('About Link' , {
              text: 'Github Repo:  ' + links.gitRepoInfoIis.desc ,
              href: links.gitRepoInfoIis.href,
              target: links.gitRepoInfoIis.target,
            }),
          ]
        },
        ...
        {  groupName: 'Create-Verify Lists',
            ...
            {  
             text: "Create/Verify InfoIis List",  
             buttonType: PropertyPaneButtonType.Primary,
