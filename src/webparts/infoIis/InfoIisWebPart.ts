...
import InfoIis from './components/InfoIis';
import { IInfoIisProps } from './components/IInfoIisProps';
 ...
 */
  ...
  public render(): void {
    const element: React.ReactElement<IInfoIisProps> = React.createElement(
      InfoIis,
      {
