...
export function buildFormFields(parentProps:IInfoIisProps , parentState: IInfoIisState ){
...
export function buildProjectFormFields(parentProps:IInfoIisProps , parentState: IInfoIisState ){
