...
import { IInfoIisState, ISaveEntry, IChartData,} from '../IInfoIisState';
...
export function creatLineChart(parentProps:IInfoIisProps , parentState: IInfoIisState, series: IChartSeries){
